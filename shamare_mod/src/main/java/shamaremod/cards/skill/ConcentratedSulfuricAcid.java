...
public class ConcentratedSulfuricAcid extends CustomCard {

    public static final String ID = IdHelper.makePath("ConcentratedSulfuricAcid");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = ImageHelper.getCardImgPath(CardType.SKILL, "ConcentratedSulfuricAcid");
    ...
    public ConcentratedSulfuricAcid() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
     ...
     public AbstractCard makeCopy() {
      return new ConcentratedSulfuricAcid();
   }
