...
import shamaremod.cards.attack.Strike;
import shamaremod.cards.skill.Defend;
...
import shamaremod.modcore.TheCore;
...
public class Shamare extends CustomPlayer {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add("ShamareKhas:Shadow");
        retVal.add("ShamareKhas:CursedApparition");
        return retVal;
    }
    ...
    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add("ShamareKhas:ShabbyDoll");
        return retVal;
    }
    ...
    public static class PlayerColorEnum {
        ...
        // ***并且名称需要一致！***
        @SpireEnum
        public static AbstractCard.CardColor SHAMARE_COLOR;
    }
    ...
    public static class PlayerLibraryEnum {
        ...
        // 这个变量未被使用（呈现灰色）是正常的
        @SpireEnum
        public static CardLibrary.LibraryType SHAMARE_COLOR;
    }
}
